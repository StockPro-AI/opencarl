...
|---------|--------|---------|
| Filename | lowercase, no extension | `.opencarl/development` |
| Alternative | lowercase with .env | `.opencarl/development.env` |
...
1. **Create file:** `.opencarl/{domainname}` (lowercase)
