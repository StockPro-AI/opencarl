...
1. **Read manifest** at `.opencarl/manifest`
...
Domain file exists at .opencarl/mydomain but has no manifest entries.
...
- Use OpenCARL Control Panel for visual toggle management
